...
def main(args):
    ...
    if args.use_wandb:
        ...
        wandb.init(entity="stablegradients", project="hw0_img_classifier_shrinivr", name="neural-the-narwhal-grayscale", config=hyperparameters)
    else:
    ...
    for t in range(args.n_epochs):
        ...
        val_correct, val_loss = evaluate(val_dataloader, "Val", model, loss_fn)
