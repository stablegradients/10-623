...
def train_one_epoch(dataloader, model, loss_fn, optimizer, t):
    ...
    for batch, (X, y) in enumerate(dataloader):
        ...
        wandb.log({"train_loss": loss, "num_train_examples": current,"sgd_step": t*size + batch})
...
def main(args):
    ...
    if args.use_wandb:
        ...
        wandb.init(project="hw0_img_classifier_shrinivr", name="neural-the-narwhal", config=hyperparameters)
    else:
    ...
    for t in range(args.n_epochs):
        ...
        wandb.log(step=t, data={"train_accuracy": train_correct, "train_loss": train_loss, "test_accuracy": test_correct, "test_loss": test_loss,})
